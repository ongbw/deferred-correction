...
for k = 1:6
    ...
    for kk = 1:Nk
        N = 2*kk+20;  % number of large (equi-spaced) time interavls 
...
for k = 1:3
    ...
    for kk = 1:Nk
        N = kk + 20;  % number of large (equi-spaced) time interavls 
        dt = (tf - ti)/N; % grid spacing, large intervals
        tspan = [0:N]*dt;
